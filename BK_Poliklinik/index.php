    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      ...
      <ul class="nav ml-auto" style="display: flex; list-style: none; padding: 0; margin-left: auto;">
        ...
        if (isset($_SESSION['pasien_id']) && $_SESSION['pasien_id'] === true) {
            ...
            echo '<li class="nav-item"><a class="nav-link" href="index.php?page=register_pasien">Register</a></li>';
            echo '<li class="nav-item"><a class="nav-link" href="index.php?page=login_pasien">Login</a></li>';
        }
        ?>
      </ul>
    </div>
